  ...
  return (
    <Card padding="lg">
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm font-medium text-text-secondary">Today&rsquo;s Weight</p>
      </div>
      ...
      {current ? (
        <div className="mt-4 flex items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">Target {weightGoal.targetWeightKg.toFixed(1)} kg</p>
